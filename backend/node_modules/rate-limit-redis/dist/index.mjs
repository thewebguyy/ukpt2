...
var RedisStore = class {
  ...
  async runCommandWithRetry(key) {
    const evalCommand = async () => this.sendCommand("EVALSHA", await this.loadedScriptSha1, "1", this.prefixKey(key), this.resetExpiryOnChange ? "1" : "0", this.windowMs.toString());
    try {
